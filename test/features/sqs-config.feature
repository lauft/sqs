Feature: sqs-config
    ...
    Scenario: Call 'sqs config set KEY VAL'
        Given I am in directory "bin"
        And there is a file named "sqsconf" with:
        """
        """
        When I run "sqs config set KEY VAL"
        Then it should pass
    ...
    Scenario: Call 'sqs config get KEY DEF'
        ...
        KEY=VAL
        """
        When I run "sqs config get KEY DEF"
        Then it should pass
